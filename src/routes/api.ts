...
import {
  ...
  getPurchases, savePurchase,
  getPayments as getCompanyPayments, savePayment as saveCompanyPayment,
  getCompanyLedger
} from '../controllers/companyController.js';
import {
  getWorkers, getWorkerById, saveWorker,
  getWorkerPayments, saveWorkerPayment, getWorkerLedger
} from '../controllers/workerController.js';
import {
  getVehicles, getVehicleById, saveVehicle,
  getDailyEntries, getDailyEntryById, saveDailyEntry,
  getVehicleReport
...
import {
  ...
  getTruckBoxes, getDeliveries, getDeliveryById, saveCustomerDelivery
} from '../controllers/truckController.js';
import {
  getBills, getBillById, createBill, recordBillPayment, downloadBillPdf, viewBillByNumber
